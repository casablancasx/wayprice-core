package com.dnilochaves.wayprice_core.infrastructure.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorDetails> handleUserValidationException(UserValidationException exception) {
        ErrorDetails errorDetails = new ErrorDetails(exception.getMessage(), "Erro de validação", HttpStatus.BAD_REQUEST.value());
